...
public class RPub {
	...
	public void ConsSubProblem(FlatG flatg, MasterProblem MP, ArrayList<ArrayList<ArrayList<Integer>>> x, ArrayList<ArrayList<ArrayList<ArrayList<Integer>>>> z, ArrayList<Arcrc> travelarcs,boolean[][] travelornot, ArrayList<ArrayList<Integer>> commoso, double MPobjvalue) throws GRBException{
	...
	public void solve1(int timelimit) throws GRBException {
		...
		System.out.println("objective_value " + objective_value);
	}
}
